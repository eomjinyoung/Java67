...
@WebServlet("/step04/lecappl/insert")
public class LectureApplInsertServlet extends HttpServlet {
  ...
  public void service(
    ...
    int rs = lectureApplDao.insert(lno, sno);
    ...
    if(rs > 0 )
    {
      ...
      out.println("alert('등록 오류.')");
    }
    out.println("window.location = 'list2?lno="+lno +" ' ");
    out.println("</script>");
